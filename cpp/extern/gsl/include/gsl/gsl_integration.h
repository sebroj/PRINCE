...
GSL_FUN gsl_integration_hermite_workspace *gsl_integration_hermite_alloc(const size_t n, const double a, const double b);

GSL_FUN void gsl_integration_hermite_free(gsl_integration_hermite_workspace * w);

GSL_FUN int gsl_integration_hermite(const gsl_function * func, double * result, gsl_integration_hermite_workspace * w);
